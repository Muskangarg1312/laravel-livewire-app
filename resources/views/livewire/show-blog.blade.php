            ...
            <div class="col-lg-3">
                ...
                <div class="widget widget-categories">
                    ...
                    <ul class="list-unstyled widget-list">
                        ...
                        <li>
                            <a wire:navigate href="{{ route('blog').'?categorySlug='.$category->slug }}">{{ $category->name }} 
                        ...
                        <li class="d-flex widget-post align-items-center">
                            <a class="text-black" href="{{ route('blogDetails', $latestArticle->id) }}" wire:navigate>
                                <div class="widget-post-image flex-shrink-0 me-3">
                                    ...
                                    <img loading="lazy" decoding="async" src="{{ asset('storage/'.$latestArticle->image) }}" alt="Post Thumbnail" class="rounded">
